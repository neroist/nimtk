...
proc paneafter*(p: PanedWindow, window: Widget): Widget {.inline.} = p.tk.newWidgetFromPathname p.panecget(window, "after")
proc panebefore*(p: PanedWindow, window: Widget): Widget {.inline.} = p.tk.newWidgetFromPathname p.panecget(window, "before")
proc paneheight*(p: PanedWindow, window: Widget): string {.inline.} = p.panecget(window, "height")
proc panehide*(p: PanedWindow, window: Widget): bool {.inline.} = parseBool p.panecget(window, "hide")
proc paneminsize*(p: PanedWindow, window: Widget): string {.inline.} = p.panecget(window, "minsize")
proc panepadx*(p: PanedWindow, window: Widget): string {.inline.} = p.panecget(window, "padx")
proc panepady*(p: PanedWindow, window: Widget): string {.inline.} = p.panecget(window, "pady")
proc panesticky*(p: PanedWindow, window: Widget): string {.inline.} = p.panecget(window, "sticky")
proc panestretch*(p: PanedWindow, window: Widget): PaneStretch {.inline.} = parseEnum[PaneStretch] p.panecget(window, "stretch")
proc panewidth*(p: PanedWindow, window: Widget): string {.inline.} = p.panecget(window, "width")
proc paneconfigure*(
  p: PanedWindow,
  window: Widget,
